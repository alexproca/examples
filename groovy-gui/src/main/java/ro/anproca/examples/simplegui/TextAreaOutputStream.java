...
public class TextAreaOutputStream extends OutputStream {
	...
	public TextAreaOutputStream(JTextArea ta, int ml) {
		if (ml < 1) {
			throw new UnsupportedOperationException("Maximum lines of " + ml + " in TextAreaOutputStream constructor is not permitted");
//			IoEscape(IoEscape.GENERAL, "Maximum lines of " + ml + " in TextAreaOutputStream constructor is not permitted");
		}
		textArea = ta;
		maxLines = ml;
